...
*/
	...
	Color.prototype = {
		...
		mix: function (mixinColor, weight) {
			...
			return this.rgb(w1 * color1.red() + w2 * color2.red(), w1 * color1.green() + w2 * color2.green(), w1 * color1.blue() + w2 * color2.blue()).alpha(
		...
		fit: function () {
			...
			if (tickOpts.display && display) {
				...
				if (isHorizontal) {
					...
					var labelHeight =
						sinRotation * widestLabelSize.width + cosRotation * (highestLabelSize.height - (isRotated ? highestLabelSize.offset : 0)) + (isRotated ? 0 : lineSpace); // padding

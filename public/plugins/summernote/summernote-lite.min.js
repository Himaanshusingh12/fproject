		...
		return (
			(() => {
										...
										ht.walkPoint(
											...
											function (e) {
												...
												ht.isEditable(e.node) ||
													(n
														? (ht.isLeftEdgePoint(e) && s.push(e.node), ht.isRightEdgePoint(e) && y.contains(s, e.node) && (i = e.node))
								...
								value: function () {
									...
									return (
										...
										ht.isText(this.sc) &&
											...
											((o.sc = this.sc.splitText(this.so)), (o.so = 0), e && ((o.ec = o.sc), (o.eo = this.eo - this.so))),
									...
									return (
										o.rightNode
											? (o.rightNode.parentNode.insertBefore(t, o.rightNode),
											  ht.isEmpty(o.rightNode) && ht.isPara(t) && o.rightNode.parentNode.removeChild(o.rightNode))
						...
						(o = [
							{
								...
								value: function () {
									...
									return {
										...
										bookmark: t && t.isOnEditable() ? t.bookmark(this.editable) : { s: { path: [], offset: 0 }, e: { path: [], offset: 0 } },
									};
								},
							},
							{
											...
											if ("LI" === l.parentNode.nodeName)
												...
												var u =
														l.childNodes.length > 1
															? ht.splitTree(l, { node: s.parentNode, offset: ht.position(s) + 1 }, { isSkipPaddingBlankHTML: !0 })
															: null,
									...
									if (i) {
										...
										if (
											(1 === this.options.blockquoteBreakingLevel
												...
												: 2 === this.options.blockquoteBreakingLevel && (r = ht.lastAncestor(i, ht.isBlockquote)),
											r)
										) {
				...
				(Rt.where = { Row: 0, Column: 1 }),
					...
					(Rt.resultAction = { Ignore: 0, SubtractSpanCount: 1, RemoveCell: 2, AddCell: 3, SumSpanCount: 4 });
				var Lt = (function () {
					function t() {
						!(function (t, e) {
							if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function");
											...
											switch (r[a].action) {
												...
												case Rt.resultAction.SubtractSpanCount:
													...
													if (s.colSpan && s.colSpan > 1) {
														...
														l > 2
															? (l--, s.setAttribute("colSpan", l), s.cellIndex === i && (s.innerHTML = ""))
															: 2 === l && (s.removeAttribute("colSpan"), s.cellIndex === i && (s.innerHTML = ""));
													}
													continue;
												case Rt.resultAction.RemoveCell:
								...
								if (!(l > 0 && n.isLimited(l))) {
									...
									"string" == typeof o && (o = o.trim()),
										n.options.onCreateLink
											...
											: a && (o = /^([A-Za-z][A-Za-z0-9+-.]*\:|#|\/)/.test(o) ? o : n.options.defaultProtocol + o);
									var u = [];
									if (c) {
								...
								value: function (t) {
									t
										...
										: ((this.lastRange = kt.create(this.editable)),
										  0 === e()(this.lastRange.sc).closest(".note-editable").length && (this.lastRange = kt.createFromBodyElement(this.editable)));
								},
							},
							{
								key: "getLastRange",
									...
									e()
										...
										.then(function (t) {
											i.beforeCommand(),
												"function" == typeof o
													? o(t)
													: ("string" == typeof o && t.attr("data-filename", o), t.css("width", Math.min(i.$editable.width(), t.width()))),
												t.show(),
							...
							},
							{
								...
								value: function (t, o) {
									if (
										...
										o && o.length && (o[0].tagName.toUpperCase() !== t.toUpperCase() && (o = o.find(t)), o && o.length))
									) {
								...
								value: function (t, o) {
									...
									if ("" !== n) {
										...
										this.$editor
											...
											.html('<div id="note-status-output-' + a + '" class="alert alert-info">' + this.lang.output.noSelection + "</div>"),
											setTimeout(function () {
										...
										this.$handle.on("mousedown", function (e) {
											if (ht.isControlSizing(e.target)) {
												...
												var o = t.$handle.find(".note-control-selection").data("target"),
													...
													r = function (e) {
														t.context.invoke("editor.resizeTo", { x: e.clientX - n.left, y: e.clientY - (n.top - i) }, o, !e.shiftKey),
															t.update(o[0], e);
													};
											...
											if (o && (o[1] || o[2])) {
												var n = o[1] ? t : "http://" + t,
													i = this.options.showDomainOnlyForAutolink
														? t.replace(/^(?:https?:\/\/)?(?:tel?:?)?(?:mailto?:?)?(?:xmpp?:?)?(?:www\.)?/i, "").split("/")[0]
														: t,
								...
								value: function (t) {
									return (
										Object.prototype.hasOwnProperty.call(this.fontInstalledMap, t) ||
											(this.fontInstalledMap[t] = f.isFontInstalled(t) || y.contains(this.options.fontNamesIgnoreCheck, t)),
											...
											children: [
												this.button({
													...
													callback: function (t) {
														...
														n &&
															(e.css("background-color", r.options.colorButton.backColor), t.attr("data-backColor", r.options.colorButton.backColor)),
															i
																? (e.css("color", r.options.colorButton.foreColor), t.attr("data-foreColor", r.options.colorButton.foreColor))
														...
														t.find(".note-holder-custom").each(function (t, n) {
															...
															t.find("input[type=color]").each(function (o, n) {
																e()(n).change(function () {
																	...
																	o.css("background-color", n).attr("aria-label", n).attr("data-value", n).attr("data-original-title", n),
																		o.click();
																});
															});
													},
										...
										return t.ui
											.buttonGroup([
												...
												t.ui.dropdown({
													...
													template: function (e) {
														"string" == typeof e &&
															(e = { tag: e, title: Object.prototype.hasOwnProperty.call(t.lang.style, e) ? t.lang.style[e] : e });
														var o = e.tag,
															n = e.title;
														return (
															"<" +
											...
											return (
												t.options.addDefaultFonts &&
													e().each(o["font-family"].split(","), function (e, o) {
														(o = o.trim().replace(/['"]+/g, "")),
															t.isFontDeservedToAdd(o) && -1 === t.options.fontNames.indexOf(o) && t.options.fontNames.push(o);
													}),
												t.ui
													.buttonGroup([
														t.button({
						...
						(n = [
							{
								...
								value: function () {
										...
										o = [
											...
											this.options.disableLinkTarget
												...
												: e()("<div></div>")
														.append(
															this.ui
																.checkbox({ className: "sn-checkbox-open-in-new-window", text: this.lang.link.openInNewWindow, checked: !0 })
																.render()
														)
														.html(),
											e()("<div></div>")
									...
									this.$dialog = this.ui
										.dialog({ className: "link-dialog", title: this.lang.link.insert, fade: this.options.dialogsFade, body: o, footer: n })
										.render()
										.appendTo(t);
								},
							},
								...
								value: function () {
									...
									return Object.keys(o)
										.map(function (n) {
											...
											return (
												r
													.append(e()("<label><kbd>" + n + "</kdb></label>").css({ width: 180, "margin-right": 10 }))
				...
				e()(document).on("click", function (t) {
					e()(t.target).closest(".note-btn-group").length ||
						(e()(".note-btn-group.open").removeClass("open"), e()(".note-btn-group .note-btn.active").removeClass("active"));
				}),
					e()(document).on("click.note-dropdown-menu", function (t) {
						e()(t.target).closest(".note-dropdown-menu").parent().removeClass("open"),
							e()(t.target).closest(".note-dropdown-menu").parent().find(".note-btn.active").removeClass("active");
					});
				const Fe = Ae;
				function De(t, e) {
					for (var o = 0; o < e.length; o++) {
								...
								_e({
									...
									click: function (n) {
										...
										if (("cp" === a ? n.stopPropagation() : "cpbackColor" === a ? (a = l) : "cpforeColor" === a && (a = s), r && a)) {
											...
											u.css(c, a),
												d.attr("data-" + r, a),
												"fore" === o ? t.itemClick("foreColor", a) : "back" === o ? t.itemClick("backColor", a) : t.itemClick(r, a);
										}
									},
								}),
							],
					...
					ui_template: function (t) {
						return {
							...
							createLayout: function (e) {
								var o = (
									t.airMode ? We([Me([Oe(), Ke()])]) : "bottom" === t.toolbarPosition ? Be([Me([Oe(), je()]), ze(), Ue()]) : Be([ze(), Me([Oe(), je()]), Ue()])
								).render();
								return (
									o.insertAfter(e),
									{

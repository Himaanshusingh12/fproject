...
function Vendor_master() {
	...
	const validation = () => {
		...
		if (vendorForm.email_statement === "") {
			...
			toast.error("Invalid Email Address for vendor requirement. Please include '@' in your email.");
			result = false;
		}
		if (vendorForm.email_payment === "") {
			...
			toast.error("Invalid Email Address for Send payment. Please include '@' in your email.");
			result = false;
		}
	...
	const handleSubmit = async (e) => {
		...
		try {
			const response = await axios.post(`${BACKEND_URL}/api/vendors`, vendorForm);
										...
										<form onSubmit={handleSubmit}>
											<div className="card-body">
												<div className="row">
													...
													<div className="col-md-6">
														<div className="form-group">
															<label htmlFor="currency">Address to send a cheque</label>
															<input
																type="text"
																name="address_send"
																id="address_send"
													...
													<div className="col-md-6">
														<div className="form-group">
															<label htmlFor="email_sales">Email Address to send a vendor statement</label>
															<input
																type="email"
													...
													<div className="col-md-6">
														<div className="form-group">
															<label htmlFor="email_statement">Email Address to send a payment remittance</label>
															<input
																type="email"
																name="email_payment"
																id="email_payment"

...
!(function (t, e) {
	...
	var E = {
			...
			resolve: function (t, e, n, i) {
				...
				for (a = 0, r = t.length; a < r; ++a)
					if (
						void 0 !== (o = t[a]) &&
						(void 0 !== e && "function" == typeof o && ((o = o(e)), (s = !1)), void 0 !== n && S.isArray(o) && ((o = o[n]), (s = !1)), void 0 !== o)
					)
	...
	N._set("global", {
		elements: { point: { radius: 3, pointStyle: "circle", backgroundColor: ct, borderColor: ct, borderWidth: 1, hitRadius: 1, hoverRadius: 4, hoverBorderWidth: 1 } },
	});
	var gt = K.extend({
			_type: "point",
			inRange: function (t, e) {
		...
		fit: function () {
			...
			if ((u ? (e.width = t.maxWidth) : s && (e.width = fn(o) + gn(r)), u ? s && (e.height = fn(o) + gn(r)) : (e.height = t.maxHeight), a.display && s)) {
				...
				if (u) {
					...
					b
						? ((w = l ? y * c.width + _ * c.offset : _ * (c.height - c.offset)), (M = l ? _ * (f.height - f.offset) : y * f.width + _ * f.offset))

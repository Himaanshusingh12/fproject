		...
		(() => {
						...
						value: function fontStyling(target, value) {
							...
							if (rng !== "") {
								...
								this.$editor
									...
									.html('<div id="note-status-output-' + noteStatusOutput + '" class="alert alert-info">' + this.lang.output.noSelection + "</div>");
								setTimeout(function () {
			...
			var Dropzone = /*#__PURE__*/ (function () {
				function Dropzone(context) {
					...
					this.$dropzone = external_jQuery_default()(['<div class="note-dropzone">', '<div class="note-dropzone-message"></div>', "</div>"].join("")).prependTo(
						this.$editor
					);
				}
				/**
			...
			var TooltipUI = /*#__PURE__*/ (function () {
				function TooltipUI($node, options) {
					...
					this.$tooltip = external_jQuery_default()(
						['<div class="note-tooltip">', '<div class="note-tooltip-arrow"></div>', '<div class="note-tooltip-content"></div>', "</div>"].join("")
					); // define event

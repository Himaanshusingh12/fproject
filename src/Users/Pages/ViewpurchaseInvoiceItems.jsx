...
function ViewPurchaseInvoiceItems() {
	...
	const fetchPurchaseinvoiceItems = async () => {
		try {
			const response = await axios.get(`${BACKEND_URL}/api/getpurchaseinvoice_items/${purchaseinvoiceId}`);
			console.log("The fetched purchase invoice items are:", response.data);
												...
												<div className="row">
													...
													<div className="col-md-6">
														...
														<div className="col-md-10">
															<label htmlFor="vendor_name">Bill To Address</label>
															<input
																type="text"
													...
													<div className="col-md-6">
														<div className="form-group">
															<label htmlFor="purchase_no">Purchase Invoice No.</label>
															<input
																type="text"
																className="form-control col-md-8"
																value={items[0]?.purchase_no || ""}
																disable
															/>
														</div>
														<div className="form-group">
...
export default ViewPurchaseInvoiceItems;

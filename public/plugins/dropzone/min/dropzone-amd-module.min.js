				...
				1320: function (e, t, n) {
					...
					(e.exports = function (e, t, n, u) {
						var s,
							...
							h = !!u && !!u.noTargetGet;
						"function" == typeof n &&
							("string" != typeof t || o(n, "name") || i(n, "name", t), (s = c(n)).source || (s.source = f.join("string" == typeof t ? t : ""))),
						...
						return (
							...
							!1 !== n.options.previewsContainer &&
								(n.options.previewsContainer
									? (n.previewsContainer = i.getElement(n.options.previewsContainer, "previewsContainer"))
									: (n.previewsContainer = n.element)),
							n.options.clickable &&
								(!0 === n.options.clickable ? (n.clickableElements = [n.element]) : (n.clickableElements = i.getElements(n.options.clickable, "clickable"))),
							n.init(),
							n
						);
					}
												...
												return (
													...
													a(function (i) {
														...
														var a = u.options.resize.call(u, e, t, n, r),
															...
															c = l?.getContext("2d");
														switch (
															((l.width = a.trgWidth), (l.height = a.trgHeight), i > 4 && ((l.width = a.trgHeight), (l.height = a.trgWidth)), i)
														) {
															case 2:
											...
											if (e[0].upload.chunked) {
												...
												var u = function () {
													...
													if (!(n >= o.upload.totalChunkCount)) {
														...
														(o.upload.chunks[n] = { file: o, index: n, dataBlock: s, status: i.UPLOADING, progress: 0, retries: 0 }),
															t._uploadData(e, [s]);
													}
												};
												if (

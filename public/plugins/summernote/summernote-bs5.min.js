										...
										ht.walkPoint(
											...
											function (e) {
												...
												ht.isEditable(e.node) ||
													(o
														? (ht.isLeftEdgePoint(e) && s.push(e.node), ht.isRightEdgePoint(e) && k.contains(s, e.node) && (i = e.node))
								...
								value: function () {
									...
									return (
										...
										ht.isText(this.sc) &&
											...
											((n.sc = this.sc.splitText(this.so)), (n.so = 0), e && ((n.ec = n.sc), (n.eo = this.eo - this.so))),
									...
									return (
										n.rightNode
											? (n.rightNode.parentNode.insertBefore(t, n.rightNode),
											  ht.isEmpty(n.rightNode) && ht.isPara(t) && n.rightNode.parentNode.removeChild(n.rightNode))
								...
								if (!(l > 0 && o.isLimited(l))) {
									...
									"string" == typeof n && (n = n.trim()),
										o.options.onCreateLink
											...
											: a && (n = /^([A-Za-z][A-Za-z0-9+-.]*\:|#|\/)/.test(n) ? n : o.options.defaultProtocol + n);
									var u = [];
									if (c) {
									...
									e()
										...
										.then(function (t) {
											i.beforeCommand(),
												"function" == typeof n
													? n(t)
													: ("string" == typeof n && t.attr("data-filename", n), t.css("width", Math.min(i.$editable.width(), t.width()))),
												t.show(),
							...
							},
							{
								...
								value: function (t, n) {
									if (
										...
										n && n.length && (n[0].tagName.toUpperCase() !== t.toUpperCase() && (n = n.find(t)), n && n.length))
									) {
										...
										this.$handle.on("mousedown", function (e) {
											if (ht.isControlSizing(e.target)) {
												...
												var n = t.$handle.find(".note-control-selection").data("target"),
													...
													r = function (e) {
														t.context.invoke("editor.resizeTo", { x: e.clientX - o.left, y: e.clientY - (o.top - i) }, n, !e.shiftKey),
															t.update(n[0], e);
													};
								...
								value: function (t) {
									return (
										Object.prototype.hasOwnProperty.call(this.fontInstalledMap, t) ||
											(this.fontInstalledMap[t] = f.isFontInstalled(t) || k.contains(this.options.fontNamesIgnoreCheck, t)),
						...
						(o = [
							{
								...
								value: function () {
									...
									this.$dialog = this.ui
										.dialog({ className: "link-dialog", title: this.lang.link.insert, fade: this.options.dialogsFade, body: n, footer: o })
										.render()
										.appendTo(t);
								},
							},
								...
								value: function () {
									...
									return Object.keys(n)
										.map(function (o) {
											...
											return (
												r
													.append(e()("<label><kbd>" + o + "</kdb></label>").css({ width: 180, "margin-right": 10 }))
							...
							? e.items
									.map(function (t) {
										...
										return (
											...
											('data-value="' + n + '"' + (void 0 !== i ? ' data-option="' + i + '"' : "")) +
						...
						return {
							...
							palette: function (e, n) {
								return Ne('<div class="note-color-palette"/>', function (e, n) {
									...
									e.html(o.join("")),
										n.tooltip && e.find(".note-color-btn").tooltip({ container: n.container || t.container, trigger: "hover", placement: "bottom" });
								})(e, n);
							},
							button: function (n, o) {
							...
							createLayout: function (e) {
								var n = (
									t.airMode ? ze([Ae([Fe(), Be()])]) : "bottom" === t.toolbarPosition ? Re([Ae([Fe(), De()]), Le(), He()]) : Re([Le(), Ae([Fe(), De()]), He()])
								).render();
								return (
									n.insertAfter(e),
									{

...
!(function (t, e) {
	...
	var E = {
			...
			resolve: function (t, e, n, i) {
				...
				for (a = 0, r = t.length; a < r; ++a)
					if (
						void 0 !== (o = t[a]) &&
						(void 0 !== e && "function" == typeof o && ((o = o(e)), (s = !1)), void 0 !== n && D.isArray(o) && ((o = o[n]), (s = !1)), void 0 !== o)
					)
	...
	Y._set("global", {
		elements: { point: { radius: 3, pointStyle: "circle", backgroundColor: ft, borderColor: ft, borderWidth: 1, hitRadius: 1, hoverRadius: 4, hoverBorderWidth: 1 } },
	});
	var mt = X.extend({
			_type: "point",
			inRange: function (t, e) {
	...
	var wt = X.extend({
			...
			draw: function () {
				...
				(t.fillStyle = e.backgroundColor),
					...
					(i.w === a.w && i.h === a.h) ||
						(t.save(), t.beginPath(), t.rect(i.x, i.y, i.w, i.h), t.clip(), (t.fillStyle = e.borderColor), t.rect(a.x, a.y, a.w, a.h), t.fill("evenodd"), t.restore());
			},
			height: function () {
				var t = this._view;
				return t.base - t.y;
					...
					for (t = 0, e = l.length; t < e; ++t)
						(n = l[t]._model),
							Bt(n, s) &&
								...
								t < l.length - 1 &&
									Bt(l[t + 1]._model, s) &&
									((n.controlPointNextX = u(n.controlPointNextX, s.left, s.right)), (n.controlPointNextY = u(n.controlPointNextY, s.top, s.bottom))));
			},
			draw: function () {
				var t,
					e = this.chart,
	...
	function fe(t, e, n) {
		...
		for (i = 0, a = t.length; i < a; ++i)
			(o = (r = t[i]).box).update(r.width || e.w, r.height || e.h, ce(r.horizontal, e)), he(e, n, r) && ((l = !0), u.length && (s = !0)), o.fullWidth || u.push(r);
		return (s && fe(u, e, n)) || l;
	}
	function ge(t, e, n) {
		var i,
	...
	B.extend(en.prototype, {
		...
		getDatasetMeta: function (t) {
			...
			return (
				n || (n = e._meta[this.id] = { type: null, data: [], dataset: null, controller: null, hidden: null, xAxisID: null, yAxisID: null, order: e.order || 0, index: t }),
				n
			);
		},
		...
		fit: function () {
			...
			if ((u ? (e.width = t.maxWidth) : s && (e.width = gn(o) + mn(r)), u ? s && (e.height = gn(o) + mn(r)) : (e.height = t.maxHeight), a.display && s)) {
				...
				if (u) {
					...
					b
						? ((k = l ? x * c.width + _ * c.offset : _ * (c.height - c.offset)), (M = l ? _ * (f.height - f.offset) : x * f.width + _ * f.offset))
		...
		for (a = 0; a < d; ++a)
			(r = t._parseValue(i[a])),
				isNaN(r.min) ||
					isNaN(r.max) ||
					n.data[a].hidden ||
					((l[a] = l[a] || 0), (u[a] = u[a] || 0), o.relativePoints ? (l[a] = 100) : r.min < 0 || r.max < 0 ? (u[a] += r.min) : (l[a] += r.max));
	}
	function On(t, e, n) {
		var i,
			a,
		...
		mi = e(function (e, n) {
			e.exports = (function () {
				...
				function qt(t, e, n) {
					...
					return (
						o < 1 ? (i = o + Zt((a = t.year() - 1), e, n)) : o > Zt(t.year(), e, n) ? ((i = o - Zt(t.year(), e, n)), (a = t.year() + 1)) : ((a = t.year()), (i = o)),
						{ week: i, year: a }
					);
				}
				function Zt(t, e, n) {
					...
					if (t._f !== a.ISO_8601)
						if (t._f !== a.RFC_2822) {
							...
							for (i = G(t._f, t._locale).match(E) || [], e = 0; e < i.length; e++)
								(r = i[e]),
									(n = (s.match(ht(r, t)) || [])[0]) &&
										((o = s.substr(0, s.indexOf(n))).length > 0 && g(t).unusedInput.push(o), (s = s.slice(s.indexOf(n) + n.length)), (u += n.length)),
				...
				function Ue(t, e) {
					var n, i;
					return e._isUTC
						? ((n = e.clone()), (i = (_(t) || u(t) ? t.valueOf() : Le(t).valueOf()) - n.valueOf()), n._d.setTime(n._d.valueOf() + i), a.updateOffset(n, !1), n)
						: Le(t).local();
				}
				function Ge(t) {
				...
				(Mn.add = en),
					...
					(Mn.isAfter = function (t, e) {
						...
						return (
							...
							("millisecond" === (e = R(e) || "millisecond") ? this.valueOf() > n.valueOf() : n.valueOf() < this.clone().startOf(e).valueOf())
						);
					}),
					...
					(Dn.monthsParse = function (t, e, n) {
						...
						for (this._monthsParse || ((this._monthsParse = []), (this._longMonthsParse = []), (this._shortMonthsParse = [])), i = 0; i < 12; i++) {
							if (
								...
								n ||
									this._monthsParse[i] ||
									((r = "^" + this.months(a, "") + "|^" + this.monthsShort(a, "")), (this._monthsParse[i] = new RegExp(r.replace(".", ""), "i"))),
			...
			(B.splineCurveMonotone = function (t) {
				...
				for (e = 0; e < h; ++e)
					(i = d[e]).model.skip ||
						...
						n &&
							!n.model.skip &&
							((u = (i.model.x - n.model.x) / 3), (i.model.controlPointPreviousX = i.model.x - u), (i.model.controlPointPreviousY = i.model.y - u * i.mK)),

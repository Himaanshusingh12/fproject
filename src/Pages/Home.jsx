          ...
          <div className="row">
            <div className="col-md-4">
              ...
              <p>
                ...
                odio aliquam laudantium voluptatibus culpa quibusdam repellat.
                Ullam dignissimos ab cupiditate, sit, delectus et veniam eius
                accusantium asperiores perferendis reprehenderit eos.
              </p>
            </div>
            <div className="col-md-4">
              ...
              <p>
                ...
                Doloribus beatae cum, assumenda velit est natus rerum ipsa qui
                accusantium incidunt veritatis corrupti officia tempora,
                architecto dicta at eos, perferendis ullam.
              </p>
            </div>
            <div className="col-md-4">
              ...
              <p>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                Officia laudantium, vero, temporibus maiores mollitia illum est
                nisi ipsa libero ab facilis vitae quod debitis ad placeat optio.
                Repellendus, delectus quia?
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="card  bg-secendary border-light shadow-sm">
                <div className="card-body text-center">
                  ...
                  <p className="card-text">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit.
                    Voluptas tempore vero ex id harum quam itaque maxime non,
                    deleniti iusto repudiandae tempora voluptate. praesentium
                    ratione sint officia suscipit.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-4 mb-4">
              <div className="card border-light shadow-sm">
                <div className="card-body text-center">
                  ...
                  <p className="card-text">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                    Vel reiciendis sunt, architecto velit debitis fugit maxime
                    non facere. Sequi ullam, magni harum corporis quidem ab
                    praesentium ratione sint officia suscipit.
                  </p>
                </div>
              </div>
            </div>
            <div className="col-md-4 mb-4">
              <div className="card border-light shadow-sm">
                <div className="card-body text-center">
                  ...
                  <p className="card-text">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                    Inventore eius, maxime quam harum quibusdam id doloribus
                    facilis possimus animi. Nemo consequatur fuga quod debitis
                    maiores amet dignissimos soluta quasi eos?
                  </p>
                </div>
              </div>
            </div>
